...
def get_test_info(config):
    ...
    elif config.sal_mode == 'SSD':
        image_root = 'dataset/test/SSD/'
        image_source = 'dataset/test/SSD/test.lst'
    elif config.sal_mode == 'DES':
        image_root = 'dataset/test/DES/'
        image_source = 'dataset/test/DES/test.lst'
    elif config.sal_mode == 'DUT':
        image_root = 'dataset/test/DUT/'
        image_source = 'dataset/test/DUT/test.lst'
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_folder', type=str, default='checkpoints/edge11')
    ...
    # Testing settings
    parser.add_argument('--model', type=str, default='pretrained/final_fuliye.pth')  # Snapshot
    # parser.add_argument('--test_folder', type=str, default='test/SIP_test_maxpool_v1_10/')  # Test results saving folder
    parser.add_argument('--test_folder', type=str, default='test/final_fuliye-NLPR')  # Test results saving folder
    parser.add_argument('--sal_mode', type=str, default='STERE',
                        choices=['NJU2K', 'NLPR', 'STERE', 'RGBD135', 'LFSD', 'SIP', 'DES', 'SSD', 'DUT'])  # Test image dataset
